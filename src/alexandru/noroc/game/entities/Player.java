...
import alexandru.noroc.game.InputHandler;
import alexandru.noroc.game.gfx.Colours;
import alexandru.noroc.game.gfx.Font;
...
public class Player extends Mob
{
    ...
    public void render(Screen screen)
    {
        ...
        if(isSwimming)
        {
            ...
            {
                yOffset -= 1;
                waterColor = Colours.get(-1, -1, 225, -1);
            } else if(15 <= tickCount % 60 && tickCount % 60 < 30)
            {
                waterColor = Colours.get(-1, 225, 115, -1);
            } else if(30 <= tickCount % 60 && tickCount % 60 < 45)
            {
                waterColor = Colours.get(-1, 115, -1, 225);
            } else
            {
                yOffset -= 1;
                waterColor = Colours.get(-1, 225, 115, -1);
